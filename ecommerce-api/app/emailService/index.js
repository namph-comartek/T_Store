...
const passwordReset = path.join(
    __dirname,
    "emails",
    "template",
    "resetPassword.ejs"
);
const createOrderEmail = path.join(
    __dirname,
    "emails",
    "template",
    "createOrderEmail.ejs"
);
const confirmOrderEmail = path.join(
    __dirname,
    "emails",
    "template",
    "confirmOrderEmail.ejs"
);
const shippedEmail = path.join(
    __dirname,
    "emails",
    "template",
    "shippedEmail.ejs"
);
const completeOrderEmail = path.join(
    __dirname,
    "emails",
    "template",
    "completeOrderEmail.ejs"
);
const contactEmail = path.join(
    __dirname,
    "emails",
    "template",
    "contactEmail.ejs"
...
async function sendEmailResetPassword(receiverEmail, resetPasswordUrl) {
    try {
        ...
        const mailOptions = {
            from: config.sendgrid.fromEmail,
            to: receiverEmail,
            subject: "T-Store! Reset password request",
            html: content,
        };
...
async function sendEmailContactEmail(receiverEmail) {
    try {
        ...
        const mailOptions = {
            from: config.sendgrid.fromEmail,
            to: receiverEmail,
            subject: "T-Store! Re: your contact 1",
            html: content,
        };
        sgMail.send(mailOptions);
    } catch (err) {
...
async function sendEmailCreateOrderEmail(receiverEmail) {
    try {
        ...
        const mailOptions = {
            from: config.sendgrid.fromEmail,
            to: receiverEmail,
            subject: "T-Store! Your order has been created",
            html: content,
        };
        sgMail.send(mailOptions);
    } catch (err) {
...
async function sendEmailShippedOrder(id) {
    ...
    try {
        ...
        const mailOptions = {
            from: config.sendgrid.fromEmail,
            to: user.email,
            subject: "T-Store! Your order was shipping",
            html: content,
        };
        sgMail.send(mailOptions);
    } catch (err) {
...
async function sendEmailConfirmOrderEmail(id) {
    ...
    try {
        ...
        const mailOptions = {
            from: config.sendgrid.fromEmail,
            to: user.email,
            subject: "T-Store! Your order has been confirmed",
            html: content,
        };
        sgMail.send(mailOptions);
    } catch (err) {
...
async function sendEmailCompleteOrderEmail(id) {
    ...
    try {
        ...
        const mailOptions = {
            from: config.sendgrid.fromEmail,
            to: user.email,
            subject: "T-Store! Your order has been completed",
            html: content,
        };
        sgMail.send(mailOptions);
    } catch (err) {
