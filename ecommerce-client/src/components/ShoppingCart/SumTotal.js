    ...
    return (
      <div>
        <div className="cart-page-total">
          ...
          <ul>
            <li>
              Subtotal <span>{amount ? formatNumber.format(amount) : 0}</span>
            </li>
            <li>
              Shipping{" "}
              <span>{formatNumber.format(amount ? shippingTotal : 0)}</span>
            </li>
            <li style={{ color: "red" }}>
              Total{" "}
              <span>
                {amount ? formatNumber.format(amount + shippingTotal) : 0}
              </span>
            </li>
          </ul>
          <button
